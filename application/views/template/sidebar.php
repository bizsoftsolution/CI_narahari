         ...
         <div class="category-content no-padding">
            <ul class="navigation navigation-main navigation-accordion">
               ...
               <?php //if($this->session->userdata('user_type')=='SUPERADMIN')
                  //  {
                  ?>
               <li ><a href="<?php echo base_url('Slider');?>"><i class="icon-people"></i> <span>Slider</span></a></li>
               <li ><a href="<?php echo base_url('Product');?>"><i class="icon-stack2"></i> <span>Products</span></a></li>
               <li ><a href="<?php echo base_url('Getquote');?>"><i class="icon-user-plus"></i> <span>Get Quote</span></a></li>
               <!--li>
                  <a href="#" class="has-ul legitRipple"><i class="icon-stack2"></i> <span>Master </span></a>
                  <ul class="hidden-ul">
                     <li><a href="" class="legitRipple">Country Details</a></li>
                     <li><a href="" class="legitRipple">Island Details</a></li>
                  </ul>
               </li-->
               <?php
                  //  }
